...
function EditPolicy() {
    ...
    async function handleSubmit(event) {
        ...
        try {
            ...
            setError(
                error.message ||
                "Unable to update the policy. Please make sure the backend is running."
            );
        } finally {
            setSaving(false);
        }
                ...
                <section className="pv-add-policy-header">
                    ...
                    <div>
                        ...
                        <p className="pv-add-policy-subtitle">
                            Fetching the policy details from
                            your PolicyVault server.
                        </p>
                    </div>
        ...
        <div className="pv-add-policy-page">
            ...
            <section className="pv-add-policy-header">
                ...
                <div>
                    ...
                    <p className="pv-add-policy-subtitle">
                        Update the details of your insurance
                        policy and keep your vault accurate.
                    </p>
                </div>
